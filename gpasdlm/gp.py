...
class GaussianProcessRegressor():
    # '''
    # The class 'GaussianProcessRegressor', is a model of Gaussian process regression which has several attributes and methods. The most important of its methods are: "fit", "predict", "simulate", "kernel_choice".
    # 1. The method "fit", estimates the hyperparameters of the kernel function of the model. .1
