...
#=================================================================
        ...
        period_est_ = get_parms_from_tfModel(newModel, y_interp)
        ...
        #===============noise std===========
        noise_std = get_parms_from_tfModel(model_periodic_noise, y_interp)
...
#=================================================================
    ...
    def periodicFitByRandomSampling(self):
        ...
        for i in range(100):
            ...
            p_est_12 = get_parms_from_tfModel(newModel, yI)
    ...
    def fit(self,method = None):
        ...
        if self._kernel.__class__.__name__ == "Periodic":
           ...
           # self._sigma_n = std_noise * stdy
            ...
            parmsfit_by_sampling = get_parms_from_tfModel(self._model, y_interp)
